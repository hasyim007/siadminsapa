/* ============================================================
   ...
   ------------------------------------------------------------
   Semua fungsi di sini fetch() ke Worker sungguhan. Isi API_BASE
   di bawah dengan URL Worker kamu (lihat PANDUAN-DEPLOY-TANPA-CLI.md
   langkah 2.8), contoh:
...
const API_BASE = ''; // TODO: isi URL Worker kamu di sini sebelum deploy
